...
`D:\AI\EducationLearning\operation-guide-learning-content`

## 事前準備

1. GitHub Release `v0.1.0-alpha.1` から `dist/operation-guide-learning-content-docs.zip` を取得できることを確認する。
