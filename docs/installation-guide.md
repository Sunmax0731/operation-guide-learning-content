...
2. `dist/operation-guide-learning-content-docs.zip`、`docs/manual-test.md`、`docs/strict-manual-test-addendum.md` を取得する。
3. repo を clone する。

```powershell
git clone https://github.com/Sunmax0731/operation-guide-learning-content.git
cd operation-guide-learning-content
